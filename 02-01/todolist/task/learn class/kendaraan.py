...
#contructor = suatu fungsi dari __init__ untuk memberi nilai properti dan dijalankan duluan dari yang lainnya jikalau tidak ada object maka init tidak bisa dijalankan
